## 2.8.1 (September 11, 2026)

NOTES:

* Upgrade the Go toolchain to 1.26.8. ([#534](https://github.com/hashicorp/terraform-provider-archive/issues/534))
* Update golang.org/x/crypto to v0.56.0, golang.org/x/mod to v0.40.0, and google.golang.org/protobuf to v1.36.12. ([#535](https://github.com/hashicorp/terraform-provider-archive/issues/535))

## 2.8.0 (May 12, 2026)

ENHANCEMENTS:

* Added linux/s390x build target for IBM Z platform support ([#504](https://github.com/hashicorp/terraform-provider-archive/issues/504))
