...
The following examples illustrate the usage of the archive_file resource, specifically for instances where replacement of the resource needs to be triggered.
