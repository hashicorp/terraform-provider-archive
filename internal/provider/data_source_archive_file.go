...
func (d *archiveFileDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	// Only create the archive if it does not already exist. This prevents
	// plan-time failures when the source content is generated by other resources
	// and avoids recreating the archive on every plan.
