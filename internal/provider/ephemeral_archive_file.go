...
var _ ephemeral.EphemeralResource = (*archiveFileEphemeralResource)(nil)
var _ ephemeral.EphemeralResourceWithConfigValidators = (*archiveFileEphemeralResource)(nil)

func NewArchiveFileEphemeralResource() ephemeral.EphemeralResource {
	return &archiveFileEphemeralResource{}
}

type archiveFileEphemeralResource struct{}

func (d *archiveFileEphemeralResource) ConfigValidators(context.Context) []ephemeral.ConfigValidator {
...
func (d *archiveFileEphemeralResource) Schema(ctx context.Context, req ephemeral.SchemaRequest, resp *ephemeral.SchemaResponse) {
...
func (d *archiveFileEphemeralResource) Open(ctx context.Context, req ephemeral.OpenRequest, resp *ephemeral.OpenResponse) {
	var model fileModel
...
func (d *archiveFileEphemeralResource) Metadata(_ context.Context, req ephemeral.MetadataRequest, resp *ephemeral.MetadataResponse) {
